  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    #step1 .step-navigation {
        justify-content: space-between; /* Alterado de flex-end para space-between */
    }
                    ...
                    <div class="form-steps-wrapper">
                        <div class="form-step active-step" id="step1">
                            ...
                            <div class="step1-js-error-message"></div> <div class="step-navigation">
                                 <button type="button" class="btn btn-secondary" id="b"  onclick="window.location.href='login.php'">Já tenho uma conta</button>
