      ...
      <form method="post" autocomplete="off">
        ...
        <dl class="dados-lista">
          ...
          <dd>
            ...
            <input type="text" name="telefone" class="input-edit" value="<?= htmlspecialchars($usuario['telefone']) ?>" style="display:none;" required oninput="this.value = formatarTelefone(this.value)" maxlength="15" />
          </dd>
