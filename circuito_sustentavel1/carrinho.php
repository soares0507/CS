...
<body>
    <header>
        ...
        <div style="margin-left:auto;">
            <button onclick="window.location.href='loja.php'" style="background: none; border: none; font-size: 2rem; color: #1f804e; cursor: pointer; font-weight: bold;">&#10005;</button>
        </div>
    </header>
    <main>
        <h1> Carrinho</h1>
